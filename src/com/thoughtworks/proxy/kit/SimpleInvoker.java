...
/**
 * A simple {@link com.thoughtworks.proxy.Invoker} implementation, that routes
 * any call to a target object. A <code>null</code> value as target can be
 * handled, the invocation result will alway be <code>null</code>.
 * 
