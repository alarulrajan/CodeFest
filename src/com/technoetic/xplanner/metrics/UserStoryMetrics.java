...
public class UserStoryMetrics {
	...
	// List acceptedTasks =
	// session.getNamedQuery("acceptedTaskInStoryQuery").setInteger("storyId",
	// userStoryId).list();
	...
	// List hoursResults =
	// session.getNamedQuery("storyHoursWorkedQuery").setInteger("storyId",
	// userStoryId).list();
	...
	// double hours =
	// duration == 0 ? (endTime.getTime() - startTime.getTime()) / 3600000.0 :
	// duration;
	...
	// }
	//
	// private DeveloperMetrics getDeveloperMetrics(String name, int id, int
	// userStoryId) {
	...
	// }
	//
	// private void updateWorkedHours(int userStoryId, String name, int id,
	// double hours,
	// boolean isPaired) {
	...
	// return (dm1.getHours() < dm2.getHours()) ? 1 : (dm1.getHours() ==
	// dm2.getHours() ? 0 : -1);
	// }
	// });
	// return metrics;
