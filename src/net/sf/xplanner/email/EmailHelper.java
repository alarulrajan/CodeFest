 ...
 * 
 * @author Maksym.Chyrkov. Copyright (C) 2009 Maksym Chyrkov This program is
...
public class EmailHelper {
	...
	public void sendEmail(final ObjectDeleted event) {
		...
		// EmailContextHelper.resolveContext(domainObject);
		// }
		//
		// try{
		//
		...
		// if((oldTask ==null) || (task.getAcceptorId() ==
		// oldTask.getAcceptorId())){
		...
		// getRepository(UserStory.class).load(storyId);
		// Map<Integer, List<Object>> notificationEmails = new HashMap<Integer,
		// List<Object>>();
		...
		// }else{
		// if(oldAcceptor != null &&((acceptor == null) ||
		// oldAcceptor.equals(acceptor))){
		// emailNotificationSupport.compileEmail(notificationEmails,
		// oldAcceptor.getId(), editor, task, story);
		// }
		// params.put(EmailFormatterImpl.TEMPLATE,
	...
	public void sendEmail(final ObjectCreated event) {
		// TODO Auto-generated method stub

	}

	public void sendEmail(final ObjectUpdated event) {
		// TODO Auto-generated method stub
