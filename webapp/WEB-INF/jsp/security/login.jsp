...
<xplanner:content>
	...
	<html:form method="post" action="/login" styleClass="loginForm"
		styleId="loginForm">
		<div id="login">
			<table>
				<tr>
					<td class="label"><label for="userId"><bean:message
								key="login.label.user_id" />:</label></td>
					<td class="userName"><div class="borderedInput">
							<div>
				...
				<tr>
					...
					<td class="password"><div class="borderedInput">
							<div>
				...
				<tr>
					<td>&nbsp;</td>
					<td class="leftAligned rememberMe"><input type="checkbox"
						name="remember" checked="checked" value="Y" /><label
						for="remember"><bean:message key="login.remember" /></label></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td class="leftAligned submit"><input type="submit"
						name="action" value="<bean:message key="login.label"/>" /> <%
	...
	<html:messages id="message" message="true"
		property='<%=AuthenticationAction.MODULE_MESSAGES_KEY%>'>
		<div class="errorMessage">
			<%= message%>
		</div>
	</html:messages>
