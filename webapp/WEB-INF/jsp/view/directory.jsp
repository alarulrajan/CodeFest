...
<xplanner:content>
	...
	<div style="margin-bottom: 0em; padding-bottom: 0em">
		...
		<html:link page="/do/view/directory?action=list" paramId="directoryId"
			paramName="root" paramProperty="id">/</html:link>
		<br />
		<logic:present name="directory" property="parent">
			<img src="<html:rewrite page="/images/folder.gif"/>" />
			<html:link page="/do/view/directory?action=list"
				paramId="directoryId" paramName="directory"
				paramProperty="parent.id">..</html:link>
			<br />
		</logic:present>
		<logic:present name="directory" property="parent">
			<img src="<html:rewrite page="/images/folder.gif"/>" />
	...
	<div style="margin-left: 0.5em;">
		<table border="0">
			<logic:iterate id="subdirectory" name="directory"
				property="subdirectories">
				<tr>
					<td><img src="<html:rewrite page="/images/folder.gif"/>" /> <html:link
							page="/do/view/directory?action=list" paramId="directoryId"
							paramName="subdirectory" paramProperty="id">
							<bean:write name="subdirectory" property="name" />
						</html:link></td>
					<td><xplanner:link page="/do/view/directory">
							<xplanner:linkParam id="action" value="rmdir" />
							<xplanner:linkParam id="directoryId" name="subdirectory"
								property="id" />
							<img border="0" src="<html:rewrite page="/images/delete.gif"/>" />
						</xplanner:link></td>
				</tr>
			</logic:iterate>
			<logic:iterate id="file" name="directory" property="files">
				<tr>
					<td style="padding-right: 2em;"><img
						src="<html:rewrite page="/images/file.gif"/>" /> <html:link
							page="/do/view/directory?action=download" paramId="fileId"
							paramName="file" paramProperty="id">
					...
					<td><xplanner:link page="/do/view/directory">
							...
							<xplanner:linkParam id="directoryId" name="directory"
								property="id" />
							<img border="0" src="<html:rewrite page="/images/delete.gif"/>" />
						</xplanner:link></td>
				</tr>
