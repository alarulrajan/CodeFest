...
<c:if test="${iteration.active}">
	<xplanner:link page="/do/view/dashboard" paramId="iterationId"
...
<xplanner:link page="/do/view/iteration/tasks" paramId="oid"
	paramName="iteration" paramProperty="id">
...
<%--</xplanner:link> |--%>
<xplanner:link page="/do/view/iteration/metrics" paramId="oid"
	paramName="iteration" paramProperty="id">
...
<xplanner:link page="/do/view/iteration/statistics" paramId="oid"
	paramName="iteration" paramProperty="id">
	<bean:message key="iteration.link.statistics" />
</xplanner:link>
<% } %>
<xplanner:link page="/do/view/iteration/accuracy" paramId="oid"
	paramName="iteration" paramProperty="id">
	<bean:message key="iteration.link.accuracy" />
</xplanner:link>
...
<xplanner:link page="/do/view/history">
	...
	<xplanner:linkParam id='<%= AbstractAction.TYPE_KEY %>'
		value='<%= Hibernate.getClass(iteration).getName() %>' />
</xplanner:link>
