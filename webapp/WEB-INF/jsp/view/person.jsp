...
<xplanner:content>
	...
	<xplanner:contentTitle title="XPlanner {0} {1}">
		<xplanner:contentTitleArg>
			<bean:message key="person.prefix" />
		</xplanner:contentTitleArg>
	...
	<span class="title"><h1>
			<bean:message key="person.label.name" />
...
<blockquote>
  <p><bean:message key="person.label.email"/> <a href="mailto:${person.email}">${person.email}</a><br>
	...
	<%-- Completed Tasks --%>
	<jsp:include page="personTaskTableFragment.jsp">
		<jsp:param name="collectionName"
			value="currentCompletedTasksForPerson" />
	...
	<jsp:include page="personStoryTableFragment.jsp">
		...
		<jsp:param name="label.none"
			value="person.label.stories.customer.none" />
	</jsp:include>
	...
	<span class="links"> <xplanner:actionButtons id="action"
			name="person">
			<%
...
%>
			...
			<% } %>
		</xplanner:actionButtons> <xplanner:link page="/do/view/people">
			<bean:message key="projects.link.people" />
		</xplanner:link> <xplanner:link page="/do/view/timesheet" paramId="oid"
			paramName="person" paramProperty="id">
			<bean:message key="person.link.timesheet" />
		</xplanner:link> <jsp:include page="exportLinks.jsp" />
	</span>
