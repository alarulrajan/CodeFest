...
<db:useBean id="feature" type="com.technoetic.xplanner.domain.Feature"
	scope="request" />
<xplanner:content definition="tiles:view">
			...
			<td>
				<table width="100%" cellspacing="0">
					<tr>
						<td nowrap>
							<p>
								<span class="title"><bean:message key="feature.prefix" />
								</span> <span class="object_name">${feature.name}</span>
							</p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><xplanner:twiki name="feature"
 ...
 <xplanner:link page="/do/view/history">
			...
			<xplanner:linkParam id='<%= AbstractAction.TYPE_KEY %>'
				value='<%= Hibernate.getClass(feature).getName() %>' />
		</xplanner:link>
	</tiles:put>
</xplanner:content>
