...
<xplanner:content>
	...
	<html:form method="post" action="view/aggregateTimesheet">
				...
				<tr border="0">
					<td margin="0" padding="0" border="0" width="150"
						...
						<div class="borderedInput ">
							<div>
								<html:select name="aggregateTimesheetForm"
					...
					<td margin="0" padding="0" valign="top">
						<div class="borderedInput dateInput">
							<div>
								<html:text styleId="startDate" name="aggregateTimesheetForm"
						...
						</div> <b><bean:message key="timesheet.label.period_end" /></b>
						<div class="borderedInput dateInput">
							<div>
								<html:text styleId="endDate" name="aggregateTimesheetForm"
		...
		<p class="stop"></p>
		<dt:table id="entry" name="aggregateTimesheetForm"
		...
		<div class="strip">
			<b>Total Hours:&nbsp;&nbsp;&nbsp;&nbsp;<bean:write
					name="aggregateTimesheetForm" property="timesheet.total" />&nbsp;&nbsp;
			</b>
		</div>
	...
	<table cellpadding="1" class="objecttable charts">
		<tr>
			<th width="100%" align="center" class="table_label"><br />
			<bean:message key="timesheet.statistics.hours_by_project" /> ( <bean:write
		...
		<tr>
			<th width="100%" align="center" class="table_label"><br /> <bean:message
		...
		<tr>
			<th width="100%" align="center" class="table_label"><br />
			<bean:message key="timesheet.statistics.hours_by_story" /> ( <bean:write
					name="aggregateTimesheetForm" property="startDateString" /> <bean:message
					key="timesheet.label.to" /> <bean:write
					name="aggregateTimesheetForm" property="endDateString" /> )</th>
		</tr>
