...
<div class="page_footer">
	<span><html:img page="/images/wider.png"
			styleClass="right deleteImg" /> switch width of Xplanner+ page </span> <a
		href="http://xplanner-plus.sourceforge.net/" target="xplanner_home">
		<%
     ...
     %> <bean:message key="app.label.version" arg0='<%=version%>'
			arg1='<%=date%>' arg2='<%=revision%>' />
	</a>
</div>
...
<div class="below_page_footer">
  ...
  %> <bean:message key="footer.message"
			arg0="<%=productionSupportEmail%>" arg1="<%=issueLink%>"
			arg2='<%=appUrl+"/do/systemInfo"%>' /> <%=logoToSF%>
	</span>
</div>
