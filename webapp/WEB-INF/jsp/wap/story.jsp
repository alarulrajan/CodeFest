...
<p>
	...
	<b>Tasks</b><br />
	<logic:iterate name="story" property="tasks" id="task"
		type="net.sf.xplanner.domain.Task">
		<a href="/xplanner/do/mobile/view/task?oid=<%=task.getId()%>"><bean:write
				name="task" property="name" /></a>
		<br />
	</logic:iterate>
</p>
</card>
...
<p>
	<b>Name:</b>
	<bean:write name="story" property="name" />
	<br /> <b>Description:</b>
	<bean:write name="story" property="description" />
	<br />
</p>
</card>
</wml>