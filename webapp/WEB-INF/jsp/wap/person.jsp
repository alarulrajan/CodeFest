...
<p>
	<small> <b>Name:</b> <bean:write name="person" property="name" /><br />
		<b>Initials:</b> <bean:write name="person" property="initials" /><br />
		<logic:notEmpty name="person" property="phone">
			<b>Phone:</b>
			<a href="wtai://wp/mc;<%= person.getPhone().replaceAll("-","") %>"><bean:write
					name="person" property="phone" /></a>
			<br />
		</logic:notEmpty> <logic:notEmpty name="person" property="email">
			<b>Email:</b>
