...
<xplanner:content definition="tiles:edit">
	...
	<bean:define id="feature" name="edit/feature"
	...
	<form method="post" action="<html:rewrite page="/do/edit/feature"/>"
		name="featureEditor">
		<logic:present parameter="oid">
		...
		<input type="hidden" name="fkey" value='<%=fkey%>'> <input
			type="hidden" name="storyId" value='<%=fkey%>'> <input
			type="hidden" name="id" value='<%= feature.getId() %>'>
		<table cellpadding="4" bgcolor="#C0C0C0" class="editor">
			<tr>
				<td nowrap valign="top"><b><bean:message
							key="feature.editor.name" /></b></td>
				<td><html:text name="feature" property="name" size="40" /></td>
			</tr>
			<tr>
				<td nowrap valign="top"><b><bean:message
							key="feature.editor.description" /></b></td>
				<td align="right"><%@ include
						file="/WEB-INF/jsp/common/formattingHelpLink.jsp"%>
				</td>
			</tr>
			<tr>
				<td colspan="2"><html:textarea name="feature"
						property="description" cols="60" rows="10" /></td>
			</tr>
			<tr>
				<td colspan="2" valign="top"><logic:present parameter="oid">
