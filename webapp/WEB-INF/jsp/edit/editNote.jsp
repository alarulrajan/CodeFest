...
<xplanner:content definition="tiles:edit">
	...
	<bean:define id="note" name="edit/note"
	...
	<form method="post" action="<html:rewrite page="/do/edit/note"/>"
		enctype="multipart/form-data" name="editNote">
		<div id="editObject">
			<logic:present parameter="oid">
			...
			<input type="hidden" name="attachedToId"
				value='<%= request.getParameter("attachedToId") %>'>
			<table class="editor">
				<tr>
					<th class="firstColumn" nowrap valign="top"><b><bean:message
								key="note.editor.subject" /></b></th>
					<td class=""><div class="borderedInput">
							<div>
								<html:text name="note" property="subject" size="40" />
							</div>
						</div></td>
				</tr>
				<tr>
					<th class="firstColumn" nowrap><b><bean:message
								key="note.editor.author" /></b></th>
					<td><div class="borderedInput">
							<div>
								...
								(
								<bean:write name="author" property="userId" />
								)
								...
								<div class="borderedInput">
									<div>
										<html:select property="authorId" name="note">
											<html:option value="0">
				...
				<tr>
					<td colspan="2"><div class="borderedInput">
							<div>
								<html:textarea name="note" property="body" cols="50" rows="10" />
							</div>
						</div></td>
				</tr>
				<logic:present parameter="oid">
					<tr>
						<th class="firstColumn" nowrap><b><bean:message
									key="note.editor.current_attachment" /></b></th>
						<td><div class="borderedInput">
								<div>
				...
				<tr>
					<td class="firstColumn" nowrap><b><bean:message
								key="note.editor.attachment" /></b></td>
					<td><div class="borderedInput">
							<div>
								<html:file name="note" property="formFile"
									value='<%= request.getParameter("formFileName")%>' />
							</div>
						</div></td>
				</tr>
				<tr>
					<td nowrap colspan="2" class="objecttable_buttons"><logic:present
						...
						</logic:notPresent> <input type="reset" name="reset"
						value="<bean:message key="form.reset"/>"></td>
				</tr>
			</table>
		</div>
	</form>
