...
<xplanner:content definition="tiles:edit">
	...
	<form name="moveContinueForm"
		action="<html:rewrite page="/do/move/continue/task"/>" method="post">
		<div id="editObject">
			<input type="hidden" name="oid" value="${task.id}"> <input
				type="hidden" name="merge" value="true"> <input
				type="hidden" name="fkey"
				value='<%= request.getParameter("fkey") %>'> <input
				type="hidden" name="action"
				value='<%=com.technoetic.xplanner.actions.MoveContinueTaskAction.MOVE_ACTION%>'>
			...
			<table class="editor">
				...
				<tr>
					<td colspan="2">
						<div class="borderedInput">
							<div>
								<html:select name="task" property="targetStoryId">
				...
				<tr class="objecttable_buttons">
					<td><input type="submit" name="actionBtn"
						id='<%= com.technoetic.xplanner.actions.MoveContinueTaskAction.MOVE_ACTION %>'
					...
					<td><input type="submit" name="actionBtn"
						id='<%= com.technoetic.xplanner.actions.MoveContinueTaskAction.CONTINUE_ACTION %>'
