...
<xplanner:content definition="tiles:edit">
	...
	<bean:define id="iteration" name="edit/iteration"
	...
	<form method="post" action="<html:rewrite page="/do/edit/iteration"/>"
		name="iterationEditor">
		<div id="editObject">
			<logic:present parameter="oid">
			...
			<input type="hidden" name="fkey" value='<%=fkey%>'> <input
				type="hidden" name="projectId" value='<%=fkey%>'> <input
				type="hidden" name="id" value='<%= iteration.getId() %>'>
			...
			<table class="editor">
				<tr>
					<th nowrap valign="top"><bean:message
							key="iteration.editor.name" /></th>
					<td class="secondColumn"><div class="borderedInput">
							<div>
								<html:text name="iteration" property="name" size="40" />
							</div>
						</div></td>
				</tr>
				<logic:present parameter="oid">
					<tr>
						<th nowrap valign="top"><b><bean:message
									key="iteration.editor.status" /></b></th>
						<td><%=messages.getMessage("iteration.status."+ iteration.getStatusKey())%></td>
					</tr>
				</logic:present>
				<tr>
					<th nowrap valign="top"><b><bean:message
								key="iteration.editor.start_date" /></b></th>
					<td><div class="borderedInput dateInput">
							<div>
								<input type="text" id="startDate" name="startDateString"
									size="12"
									value="<bean:write name="iteration" property="startDateString"/>"
									class="dateField" />&nbsp; <input type="image"
									src="<html:rewrite page="/images/calendar.gif" />" align="top"
									name="setStartDate"
									value="<bean:message key="iteration.editor.set_date"/>"
				...
				<tr>
					<th nowrap valign="top"><b><bean:message
								key="iteration.editor.end_date" /></b></th>
					<td><div class="borderedInput dateInput">
							<div>
								<input type="text" id="endDate" name="endDateString" size="12"
									value="<bean:write name="iteration" property="endDateString" />"
									class="dateField" />&nbsp; <input type="image"
									src="<html:rewrite page="/images/calendar.gif" />" align="top"
									name="setEndDate"
									value="<bean:message key="iteration.editor.set_date"/>"
				...
				<logic:present parameter="oid">
					<tr>
						<th nowrap valign="top"><b><bean:message
									key="iteration.editor.days_worked" /></b></th>
						<td><div class="borderedInput">
								<div>
									<input type="text" id="daysWorked" name="daysWorked" size="5"
										value="<bean:write name="iteration" property="daysWorked"/>" />
								</div>
							</div>&nbsp;</td>
					</tr>
				</logic:present>
				<tr>
					<th nowrap valign="top"><b><bean:message
								key="iteration.editor.description" /></b></th>
				...
				<tr>
					<td colspan="2">
						<div class="borderedInput">
							<div>
								<html:textarea name="iteration" property="description" cols="60"
									rows="10" />
							</div>
						</div>
					</td>
				...
				<tr>
					<td colspan="2" valign="top" class="objecttable_buttons"><logic:present
							parameter="oid">
