...
<%@page import="com.technoetic.xplanner.XPlannerProperties"%><html
...
%>
<bean:define id="object" name='<%=beanName%>' toScope="request"
	type="com.technoetic.xplanner.domain.Nameable" />

<head>
<c:set var="titleText">
	<bean:message key='<%=titlePrefix%>' />
</c:set>
<title>XPlanner ${titleText} <%=object==null?"":object.getName()%></title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link rel="stylesheet" media="screen"
	href="<html:rewrite page="/css/reset-min.css"/>" />
<link rel="stylesheet"
	href="<html:rewrite page='/ui/jquery-ui-1.8.11.custom.css'/>" />
<link rel="stylesheet" media="screen"
	href="<html:rewrite page="/css/base.css"/>" />
<link rel="shortcut icon" type="image/x-icon"
	href="<html:rewrite page="/images/favicon2.ico"/>" />
...
<script type="text/javascript"
	src="<html:rewrite page='/js/jquery-1.5.1.min.js'/>"></script>
<script type="text/javascript"
	src="<html:rewrite page='/js/jquery-ui-1.8.11.custom.min.js'/>"></script>
<script type="text/javascript"
	src="<html:rewrite page="/js/global.js"/>"></script>

<!--<tab:tabConfig />-->
<meta property="og:title"
	content="XPlanner ${titleText} <%=object==null?"":object.getName()%>" />
...
<body>
	<div class="page">
		...
		<div class="page_body">
			<span class="title">
				<h1>
					${titleText}&#160;<a href="#">${object.name}</a> <a class="tw"
						href="http://twitter.com/home?status=Working on ${titleText} ${object.name}"
						target="_blank"> <html:img page="/images/twitter.png"
							styleClass="right deleteImg" />
					</a>
					...
					<c:url var="shareUrl" value="http://www.facebook.com/dialog/feed">
						...
						<c:param name="picture"
							value="http://xplanner-plus.sourceforge.net/images/logo.png" />
					...
					<a target="_blank" href="${shareUrl}"><html:img
							page="/images/facebook.png" styleClass="right deleteImg" /></a>
				</h1> <!-- a class="in" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=http://www.xplannerplus.org/index.html&summary=Check out XPlanner plus: open source (free) project planning and bug tracking tool for agile teams">
   ...
   <span><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="http://www.xplannerplus.org/index.html" layout="button_count" show_faces="false" width="45" font=""></fb:like></span -->
        ...
        %>
			<jsp:include page="/WEB-INF/jsp/view/notes.jsp" flush="true">
				<jsp:param name="oid"
					value='<%= Integer.toString(object.getId()) %>' />
			</jsp:include>
			<%
          }
    %>
