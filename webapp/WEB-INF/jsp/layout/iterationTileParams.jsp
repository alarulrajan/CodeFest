...
<%@page import="com.technoetic.xplanner.format.DecimalFormat"%><tiles:put
	name="beanName">iteration</tiles:put>
<tiles:put name="titlePrefix">iteration.prefix</tiles:put>
<tiles:put name="titleSuffix"></tiles:put>
<tiles:put name="actions" direct="true"><jsp:include
		page="iteration/links.jsp" flush="true" />
</tiles:put>
<tiles:put name="globalActions" direct="true"><jsp:include
		page="iteration/globalLinks.jsp" flush="true" />
</tiles:put>
<tiles:put name="progress" direct="true">
	<div class="iterationCard">
		<div class="iterationCardHeader">
			<strong>(<xplanner:formatDate formatKey="format.date"
					name="iteration" property="startDate" /> <bean:message
					key="iteration.to" /> <xplanner:formatDate formatKey="format.date"
					name="iteration" property="endDate" />)
			</strong>
